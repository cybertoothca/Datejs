...
Date.Specification = new Specification({
  'Overview': {
    ...
    'July 8th, 2004, 10:30 PM': {
      run: function() { this.date = Date.parsePlus('July 8th, 2004, 10:30 PM') },
      assert: function() { return this.d[0].compareTo( this.date ) == 0 }
    },
    '2004.07.08 22:30': {
      run: function() { this.date = Date.parsePlus('2004.07.08 22:30') },
      assert: function() { return this.d[0].compareTo( this.date ) == 0 }
    },
    '10:30pm 08-July-2004': {
      run: function() { this.date = Date.parsePlus('10:30pm 08-July-2004') },
      assert: function() { return this.d[0].compareTo( this.date ) == 0 }
    },
    'Thu Jul 8 2004 22:30:00 GMT-0400': {
      run: function() { this.date = Date.parsePlus('Thu Jul 8 2004 22:30:00 GMT-0400') },
  ...
  'Standard Patterns': {
    ...
    '2004, July 01, 10:30:00 PM : FullDateTimePattern [dddd, MMMM dd, yyyy h:mm:ss tt]': {
      run: function() { this.date =  Date.parsePlus('2004, July 01, 10:30:00 PM') },
    ...
    'July 2004 : YearMonthPattern [MMMM, yyyy]': {
      run: function() { this.date =  Date.parsePlus('July 2004') },
    ...
    '10:30 PM : ShortTimePattern [h:mm tt]': {
      run: function() { this.date =  Date.parsePlus('10:30 PM') },
      assert: function() { return this.today.clone().set( { hour: 22, minute: 30 } ).equals( this.date ) }
    },
    '6:45 AM : ShortTimePattern [h:mm tt]': {
      run: function() { this.date =  Date.parsePlus('6:45 AM') },
      assert: function() { return this.today.clone().set( { hour: 6, minute: 45 } ).equals( this.date ) }
    },    

    '2004-07-01T22:30:00 : SortableDateTimePattern [yyyy-MM-ddTHH:mm:ss]': {
      run: function() { this.date =  Date.parsePlus('2004-07-01T22:30:00') },
      assert: function() { return this.baseline.equals( this.date ) }
    },
    '2004-07-15T06:45:00 : SortableDateTimePattern [yyyy-MM-ddTHH:mm:ss]': {
      run: function() { this.date =  Date.parsePlus('2004-07-15T06:45:00') },
      assert: function() { return this.baseline2.equals( this.date ) }
    },
    '11 Aug 2007 7:15:00 am EDT': {
      run: function() { this.date =  Date.parsePlus('11 Aug 2007 7:15:00 am EDT') },
      assert: function() { return new Date(2007,7,11,7,15,0).setTimezone('EDT').equals( this.date ) }
    },
    'Tue Nov 20 2007 08:00:00 UTC': {
      run: function() { this.date = Date.parsePlus("Tue Nov 20 2007 08:00:00 UTC") },
      assert: function() { return new Date(2007,10,20,8,0,0).setTimezone("UTC").equals( this.date ) }
    },
    '24 Apr 2008 17:00': {
      run: function() { this.date = Date.parsePlus("24 Apr 2008 17:00") },
      assert: function() { return new Date(2008,3,24,17,0,0).equals( this.date ) }
    },
    '24 April 2008 17:00': {
      run: function() { this.date = Date.parsePlus("24 April 2008 17:00") },
      assert: function() { return new Date(2008,3,24,17,0,0).equals( this.date ) }
    }   
},
    ...
    '7/1/2004 10 PM': {
      run: function() { this.date = Date.parsePlus('7/1/2004 10 PM') },
      assert: function() { return this.baseline.addMinutes(-30).equals( this.date ) }
    },
    '07/01/2004 10 PM': {
      run: function() { this.date = Date.parsePlus('07/01/2004 10 PM') },
      assert: function() { return this.baseline.addMinutes(-30).equals( this.date ) }
    },
    '07/01/04 10 PM': {
      run: function() { this.date = Date.parsePlus('07/01/04 10 PM') },
      assert: function() { return this.baseline.addMinutes(-30).equals( this.date ) }
    },
    '7/1/04 10 PM': {
      run: function() { this.date = Date.parsePlus('7/1/04 10 PM') },
      assert: function() { return this.baseline.addMinutes(-30).equals( this.date ) }
    },   
    '7/15/2004 6 AM': {
      run: function() { this.date = Date.parsePlus('7/15/2004 6 AM') },
      assert: function() { return this.baseline2.addMinutes(-45).equals( this.date ) }
    },
    '07/15/2004 6 AM': {
      run: function() { this.date = Date.parsePlus('07/15/2004 6 AM') },
      assert: function() { return this.baseline2.addMinutes(-45).equals( this.date ) }
    },
    '07/15/04 6 AM': {
      run: function() { this.date = Date.parsePlus('07/15/04 6 AM') },
      assert: function() { return this.baseline2.addMinutes(-45).equals( this.date ) }
    },
    '7/15/04 6 AM': {
      run: function() { this.date = Date.parsePlus('7/15/04 6 AM') },
      assert: function() { return this.baseline2.addMinutes(-45).equals( this.date ) }
    },
    

    '7/1/2004 10pm': {
      run: function() { this.date = Date.parsePlus('7/1/2004 10pm') },
      assert: function() { return this.baseline.addMinutes(-30).equals( this.date ) }
    },
    '07/01/2004 10pm': {
      run: function() { this.date = Date.parsePlus('07/01/2004 10pm') },
      assert: function() { return this.baseline.addMinutes(-30).equals( this.date ) }
    },
    '07/01/04 10pm': {
      run: function() { this.date = Date.parsePlus('07/01/04 10pm') },
      assert: function() { return this.baseline.addMinutes(-30).equals( this.date ) }
    },
    '7/1/04 10pm': {
      run: function() { this.date = Date.parsePlus('7/1/04 10pm') },
      assert: function() { return this.baseline.addMinutes(-30).equals( this.date ) }
    },   
     
    
    '7/15/2004 6am': {
      run: function() { this.date = Date.parsePlus('7/15/2004 6am') },
      assert: function() { return this.baseline2.addMinutes(-45).equals( this.date ) }
    },
    '07/15/2004 6am': {
      run: function() { this.date = Date.parsePlus('07/15/2004 6am') },
      assert: function() { return this.baseline2.addMinutes(-45).equals( this.date ) }
    },
    '07/15/04 6am': {
      run: function() { this.date = Date.parsePlus('07/15/04 6am') },
      assert: function() { return this.baseline2.addMinutes(-45).equals( this.date ) }
    },
    '7/15/04 6am': {
      run: function() { this.date = Date.parsePlus('7/15/04 6am') },
      assert: function() { return this.baseline2.addMinutes(-45).equals( this.date ) }
    },
    ...
    '7/1/2004 10:30 PM': {
      run: function() { this.date = Date.parsePlus('7/1/2004 10:30 PM') },
      assert: function() { return this.baseline.equals( this.date ) }
    },
    '07/01/2004 10:30 PM': {
      run: function() { this.date = Date.parsePlus('07/01/2004 10:30 PM') },
      assert: function() { return this.baseline.equals( this.date ) }
    },
    '07/01/04 10:30 PM': {
      run: function() { this.date = Date.parsePlus('07/01/04 10:30 PM') },
      assert: function() { return this.baseline.equals( this.date ) }
    },
    '7/1/04 10:30 PM': {
      run: function() { this.date = Date.parsePlus('7/1/04 10:30 PM') },
      assert: function() { return this.baseline.equals( this.date ) }
    },   
     
    
    '7/15/2004 6:45 AM': {
      run: function() { this.date = Date.parsePlus('7/15/2004 6:45 AM') },
      assert: function() { return this.baseline2.equals( this.date ) }
    },
    '07/15/2004 6:45 AM': {
      run: function() { this.date = Date.parsePlus('07/15/2004 6:45 AM') },
      assert: function() { return this.baseline2.equals( this.date ) }
    },
    '07/15/04 6:45 AM': {
      run: function() { this.date = Date.parsePlus('07/15/04 6:45 AM') },
      assert: function() { return this.baseline2.equals( this.date ) }
    },
    '7/15/04 6:45 AM': {
      run: function() { this.date = Date.parsePlus('7/15/04 6:45 AM') },
      assert: function() { return this.baseline2.equals( this.date ) }
    },
    
    
    '7/1/2004 10:30p': {
      run: function() { this.date = Date.parsePlus('7/1/2004 10:30p') },
      assert: function() { return this.baseline.equals( this.date ) }
    },
    '07/01/2004 10:30p': {
      run: function() { this.date = Date.parsePlus('07/01/2004 10:30p') },
      assert: function() { return this.baseline.equals( this.date ) }
    },
    '07/01/04 10:30p': {
      run: function() { this.date = Date.parsePlus('07/01/04 10:30p') },
      assert: function() { return this.baseline.equals( this.date ) }
    },
    '7/1/04 10:30p': {
      run: function() { this.date = Date.parsePlus('7/1/04 10:30p') },
      assert: function() { return this.baseline.equals( this.date ) }
    },   
    '7/15/2004 6:45a': {
      run: function() { this.date = Date.parsePlus('7/15/2004 6:45a') },
      assert: function() { return this.baseline2.equals( this.date ) }
    },
    '07/15/2004 6:45a': {
      run: function() { this.date = Date.parsePlus('07/15/2004 6:45a') },
      assert: function() { return this.baseline2.equals( this.date ) }
    },
    '7/15/04 6:45a': {
      run: function() { this.date = Date.parsePlus('7/15/04 6:45a') },
      assert: function() { return this.baseline2.equals( this.date ) }
    },
    '07/01 10 PM': {
    ...
    'Thu Jul 1 2004 22:30:00': {
      run: function() { this.date =  Date.parsePlus('Thu Jul 1 2004 22:30:00') },
      assert: function() { return this.baseline.compareTo( this.date ) == 0 }
    },  
    'Thu July 01 2004 22:30:00': {
      run: function() { this.date =  Date.parsePlus('Thu July 01 2004 22:30:00') },
      assert: function() { return this.baseline.compareTo( this.date ) == 0 }
    },
    'Thu Jul 15 2004 06:45:00': {
      run: function() { this.date =  Date.parsePlus('Thu Jul 15 2004 06:45:00') },
      assert: function() { return this.baseline2.compareTo( this.date ) == 0 }
    },  
    'Thu July 15 2004 06:45:00': {
      run: function() { this.date =  Date.parsePlus('Thu July 15 2004 06:45:00') },
      assert: function() { return this.baseline2.compareTo( this.date ) == 0 }
    },    
    'July 1 2004 22:30:00': {
      run: function() { this.date =  Date.parsePlus('July 1 2004 22:30:00') },
      assert: function() { return this.baseline.compareTo( this.date ) == 0 }
    }, 
    'July 01 2004 22:30:00': {
      run: function() { this.date =  Date.parsePlus('July 01 2004 22:30:00') },
      assert: function() { return this.baseline.compareTo( this.date ) == 0 }
    }, 
    'Jul 15 2004 06:45:00': {
      run: function() { this.date =  Date.parsePlus('Jul 15 2004 06:45:00') },
      assert: function() { return this.baseline2.compareTo( this.date ) == 0 }
    },  
    'July 15 2004 06:45:00': {
      run: function() { this.date =  Date.parsePlus('July 15 2004 06:45:00') },
      assert: function() { return this.baseline2.compareTo( this.date ) == 0 }
    }, 
    'July 1 2004 10 PM': {
      run: function() { this.date =  Date.parsePlus('July 1 2004 10 PM') },
      assert: function() { return this.baseline.addMinutes(-30).compareTo( this.date ) == 0 }
    }, 
    'July 1 2004 10:30 PM': {
      run: function() { this.date =  Date.parsePlus('July 1 2004 10:30 PM') },
      assert: function() { return this.baseline.compareTo( this.date ) == 0 }
    },
    'Jul 1 2004 10PM': {
      run: function() { this.date =  Date.parsePlus('Jul 1 2004 10PM') },
      assert: function() { return this.baseline.addMinutes(-30).compareTo( this.date ) == 0 }
    }, 
    'Jul 1 2004 10:30PM': {
      run: function() { this.date =  Date.parsePlus('Jul 1 2004 10:30PM') },
      assert: function() { return this.baseline.compareTo( this.date ) == 0 }
    },
    'July 1 2004 10p': {
      run: function() { this.date =  Date.parsePlus('July 1 2004 10p') },
      assert: function() { return this.baseline.addMinutes(-30).compareTo( this.date ) == 0 }
    }, 
    'July 1 2004 10:30p': {
      run: function() { this.date =  Date.parsePlus('July 1 2004 10:30p') },
      assert: function() { return this.baseline.compareTo( this.date ) == 0 }
    },
    'July 15 2004 6 AM': {
      run: function() { this.date =  Date.parsePlus('July 15 2004 6 AM') },
      assert: function() { return this.baseline2.addMinutes(-45).compareTo( this.date ) == 0 }
    }, 
    'July 15 2004 6:45 AM': {
      run: function() { this.date =  Date.parsePlus('July 15 2004 6:45 AM') },
      assert: function() { return this.baseline2.compareTo( this.date ) == 0 }
    },
    'Jul 15 2004 6AM': {
      run: function() { this.date =  Date.parsePlus('Jul 15 2004 6AM') },
      assert: function() { return this.baseline2.addMinutes(-45).compareTo( this.date ) == 0 }
    }, 
    'Jul 15 2004 6:45AM': {
      run: function() { this.date =  Date.parsePlus('Jul 15 2004 6:45AM') },
      assert: function() { return this.baseline2.compareTo( this.date ) == 0 }
    },
    'July 15 2004 6a': {
      run: function() { this.date =  Date.parsePlus('July 15 2004 6a') },
      assert: function() { return this.baseline2.addMinutes(-45).compareTo( this.date ) == 0 }
    }, 
    'July 15 2004 6:45a': {
      run: function() { this.date =  Date.parsePlus('July 15 2004 6:45a') },
      assert: function() { return this.baseline2.compareTo( this.date ) == 0 }
    },
    'July 1st 2004 10 PM': {
      run: function() { this.date =  Date.parsePlus('July 1st 2004 10 PM') },
      assert: function() { return this.baseline.addMinutes(-30).compareTo( this.date ) == 0 }
    }, 
    'July 1st 2004 10:30 PM': {
      run: function() { this.date =  Date.parsePlus('July 1st 2004 10:30 PM') },
      assert: function() { return this.baseline.compareTo( this.date ) == 0 }
    },
    'Jul 1 2004 10PM': {
      run: function() { this.date =  Date.parsePlus('Jul 1 2004 10PM') },
    ...
    'July 1st 2004 10p': {
      run: function() { this.date =  Date.parsePlus('July 1st 2004 10p') },
      assert: function() { return this.baseline.addMinutes(-30).compareTo( this.date ) == 0 }
    }, 
    'July 1st 2004 10:30p': {
      run: function() { this.date =  Date.parsePlus('July 1st 2004 10:30p') },
      assert: function() { return this.baseline.compareTo( this.date ) == 0 }
    },
    'July 15th 2004 6 AM': {
      run: function() { this.date =  Date.parsePlus('July 15th 2004 6 AM') },
      assert: function() { return this.baseline2.addMinutes(-45).compareTo( this.date ) == 0 }
    }, 
    'July 15th 2004 6:45 AM': {
      run: function() { this.date =  Date.parsePlus('July 15th 2004 6:45 AM') },
      assert: function() { return this.baseline2.compareTo( this.date ) == 0 }
    },
    'Jul 15 2004 6AM': {
      run: function() { this.date =  Date.parsePlus('Jul 15 2004 6AM') },
    ...
    'July 15th 2004 6a': {
      run: function() { this.date =  Date.parsePlus('July 15th 2004 6a') },
      assert: function() { return this.baseline2.addMinutes(-45).compareTo( this.date ) == 0 }
    }, 
    'July 15th 2004 6:45a': {
      run: function() { this.date =  Date.parsePlus('July 15th 2004 6:45a') },
      assert: function() { return this.baseline2.compareTo( this.date ) == 0 }
    },
    'July 1 10 PM': {
      run: function() { this.date =  Date.parsePlus('July 1 10 PM') },
      assert: function() { return this.baseline3.addMinutes(-30).compareTo( this.date ) == 0 }
    }, 
    'July 1 10:30 PM': {
      run: function() { this.date =  Date.parsePlus('July 1 10:30 PM') },
      assert: function() { return this.baseline3.compareTo( this.date ) == 0 }
    },
    'Jul 1 10PM': {
      run: function() { this.date =  Date.parsePlus('Jul 1 10PM') },
      assert: function() { return this.baseline3.addMinutes(-30).compareTo( this.date ) == 0 }
    }, 
    'Jul 1 10:30PM': {
      run: function() { this.date =  Date.parsePlus('Jul 1 10:30PM') },
      assert: function() { return this.baseline3.compareTo( this.date ) == 0 }
    },
    'July 1 10p': {
      run: function() { this.date =  Date.parsePlus('July 1 10p') },
      assert: function() { return this.baseline3.addMinutes(-30).compareTo( this.date ) == 0 }
    }, 
    'July 1 10:30p': {
      run: function() { this.date =  Date.parsePlus('July 1 10:30p') },
      assert: function() { return this.baseline3.compareTo( this.date ) == 0 }
    },
    'July 15 6 AM': {
      run: function() { this.date =  Date.parsePlus('July 15 6 AM') },
      assert: function() { return this.baseline4.addMinutes(-45).compareTo( this.date ) == 0 }
    }, 
    'July 15 6:45 AM': {
      run: function() { this.date =  Date.parsePlus('July 15 6:45 AM') },
      assert: function() { return this.baseline4.compareTo( this.date ) == 0 }
    },
    'Jul 15 6AM': {
      run: function() { this.date =  Date.parsePlus('Jul 15 6AM') },
      assert: function() { return this.baseline4.addMinutes(-45).compareTo( this.date ) == 0 }
    }, 
    'Jul 15 6:45AM': {
      run: function() { this.date =  Date.parsePlus('Jul 15 6:45AM') },
      assert: function() { return this.baseline4.compareTo( this.date ) == 0 }
    },
    'July 15 6a': {
      run: function() { this.date =  Date.parsePlus('July 15 6a') },
      assert: function() { return this.baseline4.addMinutes(-45).compareTo( this.date ) == 0 }
    }, 
    'July 15 6:45a': {
      run: function() { this.date =  Date.parsePlus('July 15 6:45a') },
      assert: function() { return this.baseline4.compareTo( this.date ) == 0 }
    },
    'July 1st 10 PM': {
      run: function() { this.date =  Date.parsePlus('July 1st 10 PM') },
      assert: function() { return this.baseline3.addMinutes(-30).compareTo( this.date ) == 0 }
    }, 
    'July 1st 10:30 PM': {
      run: function() { this.date =  Date.parsePlus('July 1st 10:30 PM') },
      assert: function() { return this.baseline3.compareTo( this.date ) == 0 }
    },
    'Jul 1 10PM': {
      run: function() { this.date =  Date.parsePlus('Jul 1 10PM') },
    ...
    'July 1st 10p': {
      run: function() { this.date =  Date.parsePlus('July 1st 10p') },
      assert: function() { return this.baseline3.addMinutes(-30).compareTo( this.date ) == 0 }
    }, 
    'July 1st 10:30p': {
      run: function() { this.date =  Date.parsePlus('July 1st 10:30p') },
      assert: function() { return this.baseline3.compareTo( this.date ) == 0 }
    },
    'July 15th 6 AM': {
      run: function() { this.date =  Date.parsePlus('July 15th 6 AM') },
      assert: function() { return this.baseline4.addMinutes(-45).compareTo( this.date ) == 0 }
    }, 
    'July 15th 6:45 AM': {
      run: function() { this.date =  Date.parsePlus('July 15th 6:45 AM') },
      assert: function() { return this.baseline4.compareTo( this.date ) == 0 }
    },
    'Jul 15 6AM': {
      run: function() { this.date =  Date.parsePlus('Jul 15 6AM') },
    ...
    'July 15th 6a': {
      run: function() { this.date =  Date.parsePlus('July 15th 6a') },
      assert: function() { return this.baseline4.addMinutes(-45).compareTo( this.date ) == 0 }
    }, 
    'July 15th 6:45a': {
      run: function() { this.date =  Date.parsePlus('July 15th 6:45a') },
      assert: function() { return this.baseline4.compareTo( this.date ) == 0 }
    }, 
 ...
 'Common Formats': {
    ...
    'Thursday, July 01, 2004 10:30:00 PM : "dddd, MMMM dd, yyyy h:mm:ss tt"': {
        run: function() { this.date =  Date.parsePlus('Thursday, July 01, 2004 10:30:00 PM') },
      ...
      '2004-07-15 06:45:00 -0400 : "yyyy-MM-dd HH:mm:ss Z"': {
        run: function() { this.date =  Date.parsePlus('2004-07-15 06:45:00 -0400') },
        assert: function() { return this.d[8].equals( this.date ) }
      },
      'Thu, 1 July 2004 22:30:00 GMT : "ddd, dd MMM yyyy HH:mm:ss GMT"': {
        run: function() { this.date =  Date.parsePlus('Thu, 1 July 2004 22:30:00 GMT') },
...
'ISO 8601 Formats': {
    setup: function() {
      ...
      '1997 : "YYYY"': {
        run: function() { },
        assert: function() { return Date.today().set({year: 1997, day: 1}).equals( Date.parsePlus('1997') ) }
      },
      '1997-07 : "YYYY-MM"': {
        run: function() { },
        assert: function() { return Date.july().set({year: 1997}).equals( Date.parsePlus('1997-07') ) }
      },
      '1997-07-16 : "YYYY-MM-DD"': {
        run: function() { },
        assert: function() { return Date.july().set({year: 1997, day: 16}).equals( Date.parsePlus('1997-07-16') ) }
      },      
      '1997-07-16T19:20 : "YYYY-MM-DDThh:mm"': {
        run: function() { },
        assert: function() { return new Date(1997,6,16,19,20,0).equals( Date.parsePlus('1997-07-16T19:20') ) }
      },
      ...
      '1997-07-16T19:20:15 : "YYYY-MM-DDThh:mm:ss"': {
        run: function() { },
        assert: function() { return new Date(1997,6,16,19,20,15).equals( Date.parsePlus('1997-07-16T19:20:15') ) }
      },
      ...
      '1997-07-16T19:20+01:00 : "YYYY-MM-DDThh:mmTZD"': {
        run: function() { },
        assert: function() { return new Date(1997,6,16,19,20,0).setTimezoneOffset('+0100').equals( Date.parsePlus('1997-07-16T19:20+01:00') ) }
      },
      '1997-07-16T19:20+01:00 : "YYYY-MM-DDThh:mmTZD" : parseExact': {
       ...
       '1997-07-16T19:20:30+01:00 : "YYYY-MM-DDThh:mm:ssTZD"': {
        run: function() { },
        assert: function() { return new Date(1997,6,16,19,20,30).setTimezoneOffset('+0100').equals( Date.parsePlus('1997-07-16T19:20:30+01:00') ) }
      },
...
'RFC 3339 Formats': {
    setup: function() {
      ...
      '1985-04-12T23:20:50': {
        run: function() { },
        assert: function() { return new Date(1985,3,12,23,20,50).equals( Date.parsePlus('1985-04-12T23:20:50') ) }
      },
      '1985-04-12T23:20:50Z': {
        run: function() { },
        assert: function() { return new Date(1985,3,12,23,20,50).equals( Date.parsePlus('1985-04-12T23:20:50Z') ) }
      },  
  ...
  'Quriks: Date.parse cannot handle ISO Dates with milliseconds and tz data, use new Date() instead': {
       '1997-07-16T19:20:30.045+01:00 : "YYYY-MM-DDThh:mm:ss.sTZD"': {
        run: function() { 
            ...
            this.shouldBeNull = Date.parsePlus(ISOString);
